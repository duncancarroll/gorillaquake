...
DEFINE_FCVAR_ARCHIVE(vr_2h_mode, 0);
...
DEFINE_FCVAR_ARCHIVE(vr_player_shadows, 0);
...
DEFINE_FCVAR_ARCHIVE(vr_holster_mode, 1);
DEFINE_FCVAR_ARCHIVE(vr_weapon_throw_mode, 2);
DEFINE_FCVAR_ARCHIVE(vr_weapon_throw_damage_mult, 1.0);
DEFINE_FCVAR_ARCHIVE(vr_weapon_throw_velocity_mult, 1.0);
DEFINE_FCVAR_ARCHIVE(vr_weapon_cycle_mode, 1);
DEFINE_FCVAR_ARCHIVE(vr_right_hand_weapons_only, 1);
DEFINE_FCVAR_ARCHIVE(vr_melee_bloodlust, 0);
DEFINE_FCVAR_ARCHIVE(vr_melee_bloodlust_mult, 1.0);
DEFINE_FCVAR_ARCHIVE(vr_enemy_drops, 2);
DEFINE_FCVAR_ARCHIVE(vr_enemy_drops_chance_mult, 1.0);
DEFINE_FCVAR_ARCHIVE(vr_ammobox_drops, 2);
...
DEFINE_FCVAR_ARCHIVE(vr_gorilla_locomotion, 1);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_view_drop, 15.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_hand_radius, 4.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_body_radius, 1.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_max_arm_length, 58.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_unstick_distance, 12.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_anchor_deadzone, 0.5);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_velocity_limit, 95.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_min_jump_hand_speed, 2.25);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_max_jump_speed, 0.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_max_vertical_speed, 0.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_jump_multiplier, 0.75);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_teleport_exit_nudge, 32.0);
DEFINE_FCVAR_ARCHIVE(vr_gorilla_player_unstick_distance, 96.0);
...
DEFINE_FCVAR_ARCHIVE(vr_forcegrabbable_ammo_boxes, 0);
DEFINE_FCVAR_ARCHIVE(vr_forcegrabbable_health_boxes, 0);
